...
# ─────────────────────────────────────────────
    ...
    with tab3:
        ...
        st.dataframe(
            fence_genes[['gene', 'logfoldchange', 'adj_pval', 'role']].rename(columns={
                'gene': 'Gene', 'logfoldchange': 'Log2FC', 'adj_pval': 'adj. p-value', 'role': 'Biological Role'
            }).style.background_gradient(subset=['Log2FC'], cmap='YlOrRd').format({'Log2FC': '{:.2f}', 'adj. p-value': '{:.4f}'}),
